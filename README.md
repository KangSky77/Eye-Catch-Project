...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-126%20passed-brightgreen" />
</p>
...
| [📊 모델 성능](#-모델-성능) | v5/v4/v3 실측 지표와 선택 근거 |
...
### EfficientNet-B0 v5 (밝은 홍채 데이터 보강 — 현재 배포 모델)
...
# 응답
{
  ...
  "result": "백내장 위험 단계",
  "result_code": "risk",         # normal | borderline | risk | invalid | hold
