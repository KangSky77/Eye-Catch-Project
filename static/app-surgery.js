...
const surgeryCopy = {
 ko: {
  ...
  q_post_change: '눈부심이나 다른 불편함이 수술 전에는 없었거나, 좋아지지 않고 계속되나요?',
  ...
  sym_post_glare: '눈부심·빛 번짐', sym_post_change: '새로 생기거나 지속되는 불편함', sym_post_followup: '퇴원 안내·추적 진료 확인 필요',
...
Object.assign(surgeryCopy, {
  "es": {
    ...
    "q_post_change": "¿El deslumbramiento u otras molestias aparecieron tras la cirugía o persisten sin mejorar?",
    ...
    "sym_post_change": "Molestias nuevas o persistentes",
  ...
  "fr": {
    ...
    "q_post_change": "L’éblouissement ou une autre gêne est-il apparu après l’opération ou persiste-t-il sans amélioration ?",
    ...
    "sym_post_change": "Gêne nouvelle ou persistante",
  ...
  "ja": {
    ...
    "q_post_change": "まぶしさなどの不快感は手術後に始まった、または改善せず続いていますか？",
  ...
  "zh": {
    ...
    "q_post_change": "眩光或其他不适是否在术后新出现，或持续没有好转？",
...
function hasSurgery() { return ['today','recent','past'].includes(state.riskAnswers?.surgery); }
...
const postoperativeQuestions = ['pain','vision','redness','flashes','glare','change','followup'].map(kind=>({
...
function postoperativeTriage(ctx, t) {
 ...
 const contact=a.post_change===true || a.post_followup===false || ctx.amslerAbnormal || ctx.cataractCode==='risk';
