...
const extraStrings = {
  ko: {
    ...
    vt_asym: "⚠️ 좌우 결과 차이가 관찰됐습니다. 측정 조건에 따라 달라질 수 있으므로 재검사 후에도 차이가 지속되면 안과에서 확인하세요.",
    vt_unmeasurable: "⚠️ 한쪽 눈의 측정이 완료되지 않았습니다. 조건을 확인해 재검사하고, 차이가 지속되면 안과에서 확인하세요.",
    vt_unmeasurable_both: "⚠️ 양쪽 눈 모두 측정이 완료되지 않았습니다. 조명·거리·눈 가림을 확인하고 다시 검사해 주세요.",
  ...
  en: {
    ...
    vt_asym: "⚠️ A difference between the two eyes was observed. Testing conditions can affect the result; repeat the test and seek an eye exam if the difference persists.",
    vt_unmeasurable: "⚠️ The measurement could not be completed for one eye. Check the conditions and repeat the test; seek an eye exam if the difference persists.",
    vt_unmeasurable_both: "⚠️ The measurement could not be completed for either eye. Check the lighting, distance and eye covering, then try again.",
  ...
  es: {
    ...
    vt_asym: "⚠️ Se observó una diferencia entre ambos ojos. Las condiciones pueden afectar el resultado; repita la prueba y consulte si la diferencia persiste.",
    vt_unmeasurable: "⚠️ No se pudo completar la medición de un ojo. Revise las condiciones, repita la prueba y consulte si la diferencia persiste.",
    vt_unmeasurable_both: "⚠️ No se pudo completar la medición de ninguno de los ojos. Revise la luz, la distancia y la oclusión, y repita la prueba.",
  ...
  fr: {
    ...
    vt_asym: "⚠️ Un écart entre les deux yeux a été observé. Les conditions peuvent influencer le résultat ; recommencez et consultez si l'écart persiste.",
    vt_unmeasurable: "⚠️ La mesure n'a pas pu être terminée pour un œil. Vérifiez les conditions, recommencez et consultez si l'écart persiste.",
    vt_unmeasurable_both: "⚠️ La mesure n'a pu être terminée pour aucun des deux yeux. Vérifiez l'éclairage, la distance et l'occlusion, puis recommencez.",
  ...
  ja: {
    ...
    vt_asym: "⚠️ 左右の結果に差が見られました。測定条件で変わることがあるため、再検査後も差が続く場合は眼科でご確認ください。",
    vt_unmeasurable: "⚠️ 片眼の測定を完了できませんでした。条件を確認して再検査し、差が続く場合は眼科でご確認ください。",
    vt_unmeasurable_both: "⚠️ 両眼とも測定を完了できませんでした。照明・距離・眼の遮蔽を確認して再度お試しください。",
  ...
  zh: {
    ...
    vt_asym: "⚠️ 双眼结果存在差异。测量条件可能影响结果；请重新检查，若差异持续请到眼科确认。",
    vt_unmeasurable: "⚠️ 一只眼的测量未能完成。请检查测量条件并重试；若差异持续请到眼科确认。",
    vt_unmeasurable_both: "⚠️ 双眼的测量均未能完成。请检查光线、距离和遮眼方式后重试。",
