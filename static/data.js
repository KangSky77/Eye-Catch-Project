const translations = {
    ko: {
        ...
        sim_title: "시야 체험", sim_desc: "이 질환이 진행되면 이렇게 보일 수 있어요", sim_normal: "정상 시야", sim_strength: "체험 강도", sim_disclaimer: "교육용 재현이며 실제 증상은 사람마다 다릅니다. 진단 도구가 아닙니다.",
    ...
    en: {
        ...
        sim_title: "Vision simulator", sim_desc: "How things may look as this condition progresses", sim_normal: "Normal vision", sim_strength: "Severity", sim_disclaimer: "An educational re-creation. Real symptoms vary by person. Not a diagnostic tool.",
    ...
    es: {
        ...
        sim_title: "Simulador de visión", sim_desc: "Cómo puede verse a medida que avanza la enfermedad", sim_normal: "Visión normal", sim_strength: "Intensidad", sim_disclaimer: "Recreación educativa. Los síntomas reales varían según la persona. No es una herramienta diagnóstica.",
    ...
    fr: {
        ...
        sim_title: "Simulateur de vision", sim_desc: "À quoi cela peut ressembler quand la maladie progresse", sim_normal: "Vision normale", sim_strength: "Intensité", sim_disclaimer: "Reconstitution pédagogique. Les symptômes réels varient. Ce n'est pas un outil de diagnostic.",
    ...
    ja: {
        ...
        sim_title: "見え方の体験", sim_desc: "この疾患が進行するとこう見えることがあります", sim_normal: "正常な見え方", sim_strength: "強さ", sim_disclaimer: "教育用の再現です。実際の症状は人により異なります。診断ツールではありません。",
    ...
    zh: {
        ...
        sim_title: "视觉体验", sim_desc: "随着病情发展，可能会看到这样的画面", sim_normal: "正常视觉", sim_strength: "强度", sim_disclaimer: "这是教育用的模拟，实际症状因人而异，并非诊断工具。",
