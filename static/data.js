const translations = {
    ko: {
        ...
        start_btn: "분석 시작하기", upload_title: "사진 업로드", upload_btn: "사진 선택 및 전송", camera_btn: "카메라로 바로 찍기",
        guide_title: "정확한 분석 가이드", guide_list: "<li>정면에서 촬영하세요.</li><li>빛 반사에 주의하세요.</li>",
        tips_title: "정확한 분석을 위한<br>촬영 꿀팁", tip1_t: "흔들리지 않게 촬영하세요", tip1_d: "팔꿈치를 몸에 붙이거나 벽에 기대고, 초점이 맞은 뒤 눌러주세요. 흔들리면 분석이 어려워요.", tip2_t: "플래시는 꺼주세요", tip2_d: "플래시 반사가 눈동자에 하얗게 맺히면 혼탁으로 잘못 읽힐 수 있어요. 창가나 밝은 실내에서 찍어주세요.", tip3_t: "30cm 거리를 유지하세요", tip3_d: "너무 가까우면 초점이 흐려질 수 있어요.", tips_btn: "이해했습니다!",
        ...
        pdf_doc_title: "Eye-Catch 정밀 진단 리포트", pdf_issued: "발급일자", pdf_s1: "1. 백내장 AI 분석 결과", pdf_s2: "2. 황반변성 자가진단 (Amsler Grid)", pdf_s3: "3. AI 문진 주요 소견", pdf_s4: "4. AI 3줄 요약 (Powered by Gemma)",
    ...
    en: {
        ...
        start_btn: "Start Analysis", upload_title: "Upload Photo", upload_btn: "Select & Send", camera_btn: "Take a photo now",
        ...
        pdf_doc_title: "Eye-Catch Diagnostic Report", pdf_issued: "Issued", pdf_s1: "1. Cataract AI Analysis", pdf_s2: "2. Macular Self-Test (Amsler Grid)", pdf_s3: "3. AI Survey Findings", pdf_s4: "4. AI 3-Line Summary (Powered by Gemma)",
    ...
    es: {
        ...
        start_btn: "Iniciar análisis", upload_title: "Subir foto", upload_btn: "Seleccionar foto", camera_btn: "Tomar una foto ahora",
        ...
        pdf_doc_title: "Informe Diagnóstico Eye-Catch", pdf_issued: "Fecha de emisión", pdf_s1: "1. Análisis de Cataratas por IA", pdf_s2: "2. Autoprueba Macular (Rejilla de Amsler)", pdf_s3: "3. Hallazgos de la Encuesta IA", pdf_s4: "4. Resumen de la IA en 3 líneas (Powered by Gemma)",
    ...
    fr: {
        ...
        start_btn: "Démarrer l'analyse", upload_title: "Télécharger Photo", upload_btn: "Sélectionner Photo", camera_btn: "Prendre une photo maintenant",
        guide_title: "Guide", guide_list: "<li>Regardez de face.</li><li>Évitez les reflets.</li>",
        tips_title: "Conseils photo pour<br>une analyse précise", tip1_t: "Tenez le téléphone bien stable", tip1_d: "Gardez les coudes contre le corps ou appuyez-vous au mur, et attendez la mise au point avant de déclencher. Une photo floue ne peut pas être analysée.", tip2_t: "Désactivez le flash", tip2_d: "Un reflet de flash sur la pupille peut être pris pour une opacité. Photographiez près d'une fenêtre ou dans une pièce bien éclairée.", tip3_t: "Gardez environ 30 cm de distance", tip3_d: "Trop près, la photo peut être floue.", tips_btn: "Compris !",
        ...
        pdf_doc_title: "Rapport de Diagnostic Eye-Catch", pdf_issued: "Date d'émission", pdf_s1: "1. Analyse Cataracte par IA", pdf_s2: "2. Autotest Maculaire (Grille d'Amsler)", pdf_s3: "3. Conclusions du Questionnaire IA", pdf_s4: "4. Résumé de l'IA en 3 lignes (Powered by Gemma)",
    ...
    ja: {
        ...
        start_btn: "検査開始", upload_title: "写真アップロード", upload_btn: "写真を選択して送信", camera_btn: "カメラで今すぐ撮る",
        guide_title: "正確な分析のために", guide_list: "<li>正面から撮影してください。</li><li>光の反射に注意してください。</li>",
        tips_title: "正確な分析のための<br>撮影のコツ", tip1_t: "手ブレしないように撮影", tip1_d: "肘を体につけるか壁にもたれ、ピントが合ってから撮ってください。ブレた写真は分析できません。", tip2_t: "フラッシュはオフに", tip2_d: "フラッシュの反射が瞳に白く写ると、濁りと誤読されることがあります。窓際や明るい室内で撮ってください。", tip3_t: "30cmの距離を保って", tip3_d: "近すぎるとピントがぼやけることがあります。", tips_btn: "わかりました！",
        ...
        pdf_doc_title: "Eye-Catch 精密診断レポート", pdf_issued: "発行日", pdf_s1: "1. 白内障 AI 分析結果", pdf_s2: "2. 黄斑自己検査（アムスラーグリッド）", pdf_s3: "3. AI問診の主な所見", pdf_s4: "4. AI 3行要約（Powered by Gemma）",
    ...
    zh: {
        ...
        start_btn: "开始检测", upload_title: "上传照片", upload_btn: "选择并发送照片", camera_btn: "立即用相机拍摄",
        guide_title: "准确分析指南", guide_list: "<li>请正面拍摄。</li><li>请注意避免反光。</li>",
        tips_title: "拍摄小技巧<br>让分析更准确", tip1_t: "拍摄时请保持稳定", tip1_d: "手肘贴身或靠墙固定，等对焦后再拍。照片模糊将无法分析。", tip2_t: "请关闭闪光灯", tip2_d: "闪光灯在瞳孔上的反光可能被误判为混浊。请在窗边或明亮的室内拍摄。", tip3_t: "保持约30厘米距离", tip3_d: "太近可能会导致焦点模糊。", tips_btn: "明白了！",
        ...
        pdf_doc_title: "Eye-Catch 精密诊断报告", pdf_issued: "签发日期", pdf_s1: "1. 白内障 AI 分析结果", pdf_s2: "2. 黄斑自测（阿姆斯勒方格表）", pdf_s3: "3. AI问诊主要发现", pdf_s4: "4. AI 三行摘要（Powered by Gemma）",
