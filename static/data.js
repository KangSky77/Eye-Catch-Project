...
const translations = {
    ko: {
        ...
        ai_normal: "사진에서 뚜렷한 진행성 혼탁 특징이 감지되지 않았습니다 (초기 백내장은 사진으로 확인이 어렵습니다)", ai_risk: "강한 혼탁 특징 감지 (안과 정밀 검사 권장)", ai_borderline: "혼탁 특징 감지 (재촬영 후 재검사 또는 안과 검진 권장)", ai_uncertain: "사진만으로 판단이 어렵습니다 (약한 혼탁 특징 신호) — 눈을 한쪽씩 가까이 찍어 다시 확인해 주세요", closeup_hint: "얼굴 사진보다 눈을 한쪽씩 가까이(20~30cm) 찍으면 훨씬 정확해요.", closeup_btn: "눈 클로즈업으로 다시 찍기", ai_invalid: "이 사진에서는 눈을 확인하지 못했어요. 밝은 곳에서 눈이 화면을 가득 채우도록 20~30cm 거리에서 다시 찍어주세요. (눈 사진인데도 반복되면 화질이 낮거나 눈이 너무 작게 담긴 경우입니다)", ai_eyes_hidden: "눈이 감겨 있거나 가려진 것 같아요. 눈을 크게 뜨고 안경·선글라스를 벗은 뒤 다시 찍어주세요.",
        ai_multiple_faces: "여러 얼굴이 감지됐어요. 한 사람만 정면에서 다시 촬영해 주세요.",
        ai_incomplete_eyes: "얼굴 사진에서 한쪽 눈만 확인됐어요. 두 눈이 모두 보이게 다시 촬영해 주세요.",
        ai_hold: "조명 반사가 강해 판독할 수 없어요. 플래시를 끄고 직접 반사가 없는 고른 조명에서 다시 찍어주세요.",
        ai_blurry: "사진이 흔들려 판독할 수 없어요. 팔꿈치를 고정하고 또렷하게 다시 찍어주세요.",
        ai_low_resolution: "사진 해상도가 너무 낮아 판독할 수 없어요. 축소된 이미지 대신 더 큰 원본 사진을 선택해 주세요.",
        ...
        err_img_resolution: "사진 해상도가 너무 높아 분석할 수 없어요. 카메라의 고해상도(50MP·200MP) 설정을 끄고 다시 찍어주세요.",
        err_img_invalid: "사진 파일을 읽을 수 없어요. 다른 사진으로 다시 시도해 주세요.",
        err_ai_not_ready: "AI 모델이 아직 준비되지 않았어요. 잠시 후 다시 시도해 주세요.",
        err_validator_busy: "눈 사진 확인 기능을 지금 쓸 수 없어요. 잠시 후 다시 시도해 주세요.",
    ...
    en: {
        ...
        ai_normal: "No clear progressive opacity features in the photo (early cataract is hard to see in a photo)", ai_risk: "Strong opacity features detected (detailed eye exam recommended)", ai_borderline: "Opacity features detected (retake the photo or consider an eye exam)", ai_uncertain: "Hard to judge from this photo (weak opacity signal) — retake each eye up close", closeup_hint: "Photographing each eye up close (20–30 cm) is much more accurate than a face photo.", closeup_btn: "Retake as an eye close-up", ai_invalid: "We could not identify an eye in this photo. Retake it in good light with the eye filling the frame, about 20-30 cm away. (If it is an eye photo and this keeps happening, the image quality may be too low or the eye too small in frame.)", ai_eyes_hidden: "Your eyes look closed or covered. Open them wide, remove glasses or sunglasses, and retake the photo.",
        ai_multiple_faces: "Multiple faces were detected. Please retake the photo with one person facing the camera.",
        ai_incomplete_eyes: "Only one eye was found in the face photo. Retake it with both eyes visible.",
        ai_hold: "Too much light reflection to read this photo. Turn the flash off and retake it in soft, even light without direct reflections.",
        ai_blurry: "The photo is too blurry to read. Steady your arm and retake a sharp photo.",
        ai_low_resolution: "The photo resolution is too low to analyze. Choose a larger original photo instead of a reduced image.",
        ...
        pdf_doc_title: "Eye-Catch Eye Health Report", pdf_issued: "Issued", pdf_s1: "1. Cataract AI Analysis", pdf_s2: "2. Macular Self-Test (Amsler Grid)", pdf_s3: "3. AI Survey Findings", pdf_s4: "4. AI 3-Line Summary (Powered by Gemma)",
        ...
        err_img_resolution: "That photo's resolution is too high to analyse. Turn off your camera's high-resolution mode (50MP/200MP) and take it again.",
        err_img_invalid: "That image file could not be read. Please try a different photo.",
        err_ai_not_ready: "The AI model is not ready yet. Please try again in a moment.",
        err_validator_busy: "The eye-photo check is unavailable right now. Please try again in a moment.",
    ...
    es: {
        ...
        ai_normal: "Sin rasgos claros de opacidad avanzada en la foto (la catarata inicial es difícil de ver en una foto)", ai_risk: "Rasgos de opacidad intensos (se recomienda examen oftalmológico detallado)", ai_borderline: "Rasgos de opacidad detectados (repita la foto o considere un examen ocular)", ai_uncertain: "Difícil de juzgar con esta foto (señal débil de opacidad): vuelva a fotografiar cada ojo de cerca", closeup_hint: "Fotografiar cada ojo de cerca (20–30 cm) es mucho más preciso que una foto del rostro.", closeup_btn: "Volver a tomar en primer plano", ai_invalid: "No hemos podido identificar un ojo en esta foto. Repítala con buena luz, con el ojo llenando el encuadre, a unos 20-30 cm. (Si es una foto de un ojo y se repite, la calidad puede ser baja o el ojo demasiado pequeño.)", ai_eyes_hidden: "Parece que los ojos están cerrados o cubiertos. Ábralos bien, quítese las gafas y vuelva a tomar la foto.",
        ai_multiple_faces: "Se detectaron varios rostros. Vuelva a tomar la foto con una sola persona de frente.",
        ai_incomplete_eyes: "Solo se detectó un ojo en la foto del rostro. Repita la foto mostrando ambos ojos.",
        ai_hold: "Hay demasiado reflejo para analizar la foto. Apague el flash y repita la toma con luz suave y uniforme, sin reflejos directos.",
        ai_blurry: "La foto está demasiado movida. Apoye el brazo y repita la toma con nitidez.",
        ai_low_resolution: "La resolución de la foto es demasiado baja para analizarla. Elija una foto original de mayor tamaño en lugar de una imagen reducida.",
        ...
        pdf_doc_title: "Informe de salud ocular Eye-Catch", pdf_issued: "Fecha de emisión", pdf_s1: "1. Análisis de Cataratas por IA", pdf_s2: "2. Autoprueba Macular (Rejilla de Amsler)", pdf_s3: "3. Hallazgos de la Encuesta IA", pdf_s4: "4. Resumen de la IA en 3 líneas (Powered by Gemma)",
        ...
        err_img_resolution: "La resolución de la foto es demasiado alta para analizarla. Desactive el modo de alta resolución (50MP/200MP) de la cámara y repita la foto.",
        err_img_invalid: "No se pudo leer el archivo de imagen. Pruebe con otra foto.",
        err_ai_not_ready: "El modelo de IA aún no está listo. Inténtelo de nuevo en un momento.",
        err_validator_busy: "La comprobación de la foto del ojo no está disponible ahora. Inténtelo de nuevo en un momento.",
    ...
    fr: {
        ...
        ai_normal: "Aucun signe net d'opacité évolutive sur la photo (une cataracte débutante y est difficile à voir)", ai_risk: "Signes d'opacité marqués (examen ophtalmologique approfondi recommandé)", ai_borderline: "Signes d'opacité détectés (reprenez la photo ou envisagez un examen ophtalmologique)", ai_uncertain: "Difficile à juger sur cette photo (signal d'opacité faible) — reprenez chaque œil de près", closeup_hint: "Photographier chaque œil de près (20–30 cm) est bien plus précis qu'une photo du visage.", closeup_btn: "Reprendre en gros plan", ai_invalid: "Nous n'avons pas pu identifier d'œil sur cette photo. Reprenez-la avec un bon éclairage, l'œil remplissant le cadre, à 20-30 cm. (S'il s'agit bien d'un œil et que cela persiste, la qualité est peut-être trop faible ou l'œil trop petit dans l'image.)", ai_eyes_hidden: "Vos yeux semblent fermés ou cachés. Ouvrez-les bien, retirez lunettes ou lunettes de soleil, puis reprenez la photo.",
        ai_multiple_faces: "Plusieurs visages ont été détectés. Reprenez la photo avec une seule personne de face.",
        ai_incomplete_eyes: "Un seul œil a été détecté sur la photo du visage. Reprenez-la avec les deux yeux visibles.",
        ai_hold: "Trop de reflet pour analyser la photo. Désactivez le flash et reprenez-la sous une lumière douce et uniforme, sans reflet direct.",
        ai_blurry: "La photo est trop floue. Stabilisez votre bras et reprenez une photo nette.",
        ai_low_resolution: "La résolution de la photo est trop faible pour l’analyser. Choisissez une photo originale de plus grande taille plutôt qu’une image réduite.",
        ...
        pdf_doc_title: "Rapport de santé oculaire Eye-Catch", pdf_issued: "Date d'émission", pdf_s1: "1. Analyse Cataracte par IA", pdf_s2: "2. Autotest Maculaire (Grille d'Amsler)", pdf_s3: "3. Conclusions du Questionnaire IA", pdf_s4: "4. Résumé de l'IA en 3 lignes (Powered by Gemma)",
        ...
        err_img_resolution: "La résolution de la photo est trop élevée pour l'analyse. Désactivez le mode haute résolution (50MP/200MP) de l'appareil photo et reprenez la photo.",
        err_img_invalid: "Impossible de lire ce fichier image. Essayez une autre photo.",
        err_ai_not_ready: "Le modèle IA n'est pas encore prêt. Réessayez dans un instant.",
        err_validator_busy: "La vérification de la photo de l'œil est indisponible. Réessayez dans un instant.",
    ...
    ja: {
        ...
        ai_normal: "写真に明らかな進行性混濁の特徴はありません（初期白内障は写真では確認しにくい）", ai_risk: "強い混濁の特徴を検出（眼科での精密検査を推奨）", ai_borderline: "混濁の特徴を検出（再撮影または眼科検診を推奨）", ai_uncertain: "この写真では判断が難しい（弱い混濁の兆候）— 片目ずつ近くで撮り直してください", closeup_hint: "顔全体より片目ずつ近く（20〜30cm）で撮る方がずっと正確です。", closeup_btn: "目のアップで撮り直す", ai_invalid: "この写真では目を確認できませんでした。明るい場所で、目が画面いっぱいに入るよう20〜30cmの距離で撮り直してください。（目の写真なのに繰り返す場合は、画質が低いか目が小さく写っている可能性があります）", ai_eyes_hidden: "目が閉じているか隠れているようです。目を大きく開け、眼鏡・サングラスを外して撮り直してください。",
        ai_multiple_faces: "複数の顔が検出されました。1人だけ正面を向いて撮り直してください。",
        ai_incomplete_eyes: "顔写真では片目しか確認できませんでした。両目が見えるように撮り直してください。",
        ai_hold: "光の反射が強く判読できません。フラッシュをオフにし、直接反射のない均一で柔らかな光で撮り直してください。",
        ai_blurry: "写真がぶれていて判読できません。腕を固定して、はっきり撮り直してください。",
        ai_low_resolution: "写真の解像度が低すぎて解析できません。縮小画像ではなく、より大きな元の写真を選んでください。",
        ...
        pdf_doc_title: "Eye-Catch 目の健康レポート", pdf_issued: "発行日", pdf_s1: "1. 白内障 AI 分析結果", pdf_s2: "2. 黄斑自己検査（アムスラーグリッド）", pdf_s3: "3. AI問診の主な所見", pdf_s4: "4. AI 3行要約（Powered by Gemma）",
        ...
        err_img_resolution: "写真の解像度が高すぎて解析できません。カメラの高解像度モード（50MP・200MP）をオフにして撮り直してください。",
        err_img_invalid: "画像ファイルを読み込めませんでした。別の写真でお試しください。",
        err_ai_not_ready: "AIモデルの準備がまだできていません。少し経ってから再試行してください。",
        err_validator_busy: "目の写真チェック機能を今は利用できません。少し経ってから再試行してください。",
    ...
    zh: {
        ...
        ai_normal: "照片中未检测到明显的进行性混浊特征（早期白内障难以通过照片确认）", ai_risk: "检测到明显混浊特征（建议眼科精密检查）", ai_borderline: "检测到混浊特征（建议重新拍摄或进行眼科检查）", ai_uncertain: "仅凭此照片难以判断（轻微混浊信号）— 请分别近距离重拍每只眼睛", closeup_hint: "分别近距离（20–30厘米）拍摄每只眼睛比拍摄整张脸准确得多。", closeup_btn: "重拍眼部特写", ai_invalid: "未能在这张照片中确认眼睛。请在光线充足处，让眼睛充满画面，于20–30厘米距离重新拍摄。（若确实是眼睛照片但反复出现，可能是画质过低或眼睛在画面中太小。）", ai_eyes_hidden: "眼睛似乎闭着或被遮挡。请睁大眼睛，摘下眼镜或墨镜后重新拍摄。",
        ai_multiple_faces: "检测到多张脸。请只让一个人正面对镜头重新拍摄。",
        ai_incomplete_eyes: "面部照片中只检测到一只眼睛。请让双眼都清晰可见后重新拍摄。",
        ai_hold: "光线反射过强，无法判读。请关闭闪光灯，在无直接反光的柔和、均匀光线下重新拍摄。",
        ai_blurry: "照片模糊无法判读。请固定手臂，重新拍摄清晰的照片。",
        ai_low_resolution: "照片分辨率太低，无法分析。请选择尺寸更大的原始照片，不要使用缩小后的图片。",
        ...
        pdf_doc_title: "Eye-Catch 眼健康报告", pdf_issued: "签发日期", pdf_s1: "1. 白内障 AI 分析结果", pdf_s2: "2. 黄斑自测（阿姆斯勒方格表）", pdf_s3: "3. AI问诊主要发现", pdf_s4: "4. AI 三行摘要（Powered by Gemma）",
        ...
        err_img_resolution: "照片分辨率过高，无法分析。请关闭相机的高分辨率模式（50MP/200MP）后重新拍摄。",
        err_img_invalid: "无法读取该图片文件。请换一张照片重试。",
        err_ai_not_ready: "AI 模型尚未就绪。请稍后再试。",
        err_validator_busy: "目前无法使用眼部照片检查功能。请稍后再试。",
...
Object.assign(translations.ko, {
  ...
  find_cat_normal: "백내장 AI가 이번 사진에서 뚜렷한 혼탁 특징을 감지하지 않았습니다. 다만 초기 백내장은 겉사진에 나타나지 않을 수 있어, 이 결과로 백내장을 배제할 수는 없습니다.", find_cat_uncertain: "백내장 AI가 이번 사진에서 약한 혼탁 특징 신호를 보았지만 사진만으로는 판단이 어렵습니다. 눈을 한쪽씩 가까이 찍어 다시 확인하고, 신호가 반복되면 안과 검진을 받아보세요.",
...
Object.assign(translations.en, {
  ...
  find_cat_normal: "The cataract AI did not detect clear clouding features in this photo. Early cataract may not be visible from the outside, so this result cannot rule cataract out.", find_cat_uncertain: "The cataract AI saw a weak opacity signal in this photo, but it cannot be judged from the photo alone. Retake each eye up close; if the signal repeats, consider an eye exam.",
...
Object.assign(translations.es, {
  score_label: "Puntuación de rasgos IA",
  ...
  find_cat_normal: "La IA no detectó rasgos claros de opacidad en esta foto. Las cataratas iniciales pueden no verse desde fuera, así que este resultado no las descarta.", find_cat_uncertain: "La IA vio una señal débil de opacidad, pero no puede juzgarse solo con la foto. Vuelva a fotografiar cada ojo de cerca; si la señal se repite, considere un examen ocular.",
...
Object.assign(translations.fr, {
  score_label: "Score de signes IA",
  ...
  find_cat_normal: "L'IA n'a pas détecté de signes nets d'opacification sur cette photo. Une cataracte débutante peut ne pas être visible de l'extérieur ; ce résultat ne l'exclut donc pas.", find_cat_uncertain: "L'IA a vu un signal d'opacité faible, impossible à juger sur la seule photo. Reprenez chaque œil de près ; si le signal se répète, envisagez un examen ophtalmologique.",
...
Object.assign(translations.ja, {
  ...
  find_cat_normal: "今回の写真では明らかな混濁の特徴は検出されませんでした。初期白内障は外観に現れないことがあるため、この結果で白内障を否定することはできません。", find_cat_uncertain: "白内障AIは弱い混濁の兆候を見ましたが、写真だけでは判断できません。片目ずつ近くで撮り直し、繰り返し出るなら眼科検診を受けてください。",
...
Object.assign(translations.zh, {
  ...
  find_cat_normal: "本次照片未检测到明显的混浊特征。早期白内障可能在外观上看不出来，因此该结果不能排除白内障。", find_cat_uncertain: "白内障AI在此照片中看到轻微混浊信号，但仅凭照片无法判断。请分别近距离重拍每只眼睛；若信号重复出现，请到眼科检查。",
