const translations = {
    ko: {
        ...
        ai_normal: "특이 소견 없음 (정상)", ai_risk: "백내장 위험 단계 (정밀 검사 권장)", ai_hold: "판독 보류 (강한 조명 반사 감지됨)", ai_invalid: "눈 사진이 아닌 것 같아요. 눈을 가까이서 촬영한 사진을 올려주세요.",
    ...
    en: {
        ...
        ai_normal: "No significant findings (Normal)", ai_risk: "Cataract risk stage (Detailed exam recommended)", ai_hold: "Analysis on hold (Strong glare detected)", ai_invalid: "This doesn't look like an eye photo. Please upload a close-up of your eye.",
    ...
    es: {
        ...
        ai_normal: "Sin hallazgos significativos (Normal)", ai_risk: "Riesgo de cataratas (Se recomienda examen detallado)", ai_hold: "Análisis en espera (Reflejo de luz fuerte detectado)", ai_invalid: "Esto no parece una foto de un ojo. Suba un primer plano de su ojo.",
    ...
    fr: {
        ...
        ai_normal: "Aucune anomalie notable (Normal)", ai_risk: "Stade de risque de cataracte (Examen approfondi recommandé)", ai_hold: "Analyse en attente (Fort reflet lumineux détecté)", ai_invalid: "Cela ne ressemble pas à une photo d'œil. Veuillez téléverser un gros plan de votre œil.",
    ...
    ja: {
        ...
        ai_normal: "特記所見なし（正常）", ai_risk: "白内障リスク段階（精密検査を推奨）", ai_hold: "判読保留（強い光の反射を検出）", ai_invalid: "目の写真ではないようです。目のクローズアップ写真をアップロードしてください。",
    ...
    zh: {
        ...
        ai_normal: "无明显异常（正常）", ai_risk: "白内障风险阶段（建议精密检查）", ai_hold: "判读暂缓（检测到强光反射）", ai_invalid: "这看起来不像眼睛照片。请上传眼部特写照片。",
