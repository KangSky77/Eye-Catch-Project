...
// 리포트 탭 진입 시 — 아직 검사를 안 했으면 왜 비어 있는지 안내 (app-core.js showTab에서 호출)
function onReportTabShown() {
    if (!state.aiResult) {
        showToast(translations[state.lang].report_hint_empty || "Run the AI analysis first.", 'info');
    }
}
